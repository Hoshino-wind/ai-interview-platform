import { PrismaClient, QuestionType, Difficulty, UserRole } from '@prisma/client';
...
// Fix the memory leak and race conditions in the code above`,
  ...
  for (const questionData of questions) {
    const question = await prisma.question.upsert({
      where: {
        id: '', // Will create new since id is auto-generated
      },
      update: {},
      create: questionData,
    });
